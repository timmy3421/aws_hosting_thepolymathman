        ...
        response_header_policy = cloudfront.ResponseHeadersPolicy(self,idSecHeaders,
            ...
            security_headers_behavior=cloudfront.ResponseSecurityHeadersBehavior(
                content_security_policy=cloudfront.ResponseHeadersContentSecurityPolicy(
                    ...
                    "object-src 'none'; script-src 'self' 'unsafe-inline' data: pagead2.googlesyndication.com storage.googleapis.com googleads.g.doubleclick.net ajax.googleapis.com; "
